...
class UserPropertyTest {
    ...
    void passwordHashingSecurityProperty(@ForAll @StringLength(min = 8, max = 16) String password) {
    ...
    void identicalPasswordsDifferentHashes(@ForAll @StringLength(min = 8, max = 16) String password) {
        User user1 = new User();
        User user2 = new User();
