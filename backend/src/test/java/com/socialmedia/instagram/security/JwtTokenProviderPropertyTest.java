...
class JwtTokenProviderPropertyTest {
    ...
    private static final String TEST_ISSUER = "instagram-analytics";
    private static final String TEST_AUDIENCE = "instagram-analytics-clients";
    
    private JwtTokenProvider createProvider() {
        return new JwtTokenProvider(TEST_SECRET, ACCESS_TOKEN_EXPIRATION, REFRESH_TOKEN_EXPIRATION, TEST_ISSUER, TEST_AUDIENCE);
    }
